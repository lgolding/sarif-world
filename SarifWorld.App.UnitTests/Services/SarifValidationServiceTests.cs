...
namespace SarifWorld.App.Services
{
    public class SarifValidationServiceTests
    {
        ...
        {
            const string FileName = "SchemaErrors.sarif";
        ...
        [Fact]
        public void SarifValidationService_WhenInputFileHasSarifErrors_ReportsValidationResults()
        {
            const string FileName = "SarifWarnings.sarif";
